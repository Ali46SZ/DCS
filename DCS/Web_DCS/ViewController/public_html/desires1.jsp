...
String []desir ={"الفة الاجنبية الاولى","االلغة الفرنسية "," التاريخ ","الجغرافيا ","الفلسفة","علم النفس","الاجتماع ","الدراسات السكانية ","علوم المسرح","اللغة العربية ","الدراسات الاسلامية ","الاثار","المكتبات","الاعلام"};
          ...
          if(Student.relgion==2 && Student.state==1) size = 9;
                                %>
                            ...
                            <div class="col-lg-6">
                                <div class="col-md-8">
                                    <form role="form">
                                        ...
                                        {
                                        if(size==14 ){ if(i==9 || i==10) continue; } 
                                      %>
                                                <option value="<%=i%>">
                                                    <%=desir[i]%>
                                                </option>
     ...
     try{
       int id[]= new int [14];
           ...
           alert("رجاءعدم تكرار الرغبات من فضلك اعد المحاوله");
              ...
              +" VALUES(NULL,"+id[0]+","+id[1]+","+id[2]+","+id[3]+","+id[4]+","+id[5]+","+id[6]+","+id[7]+","+id[8]+","+id[9]+","+id[10]+","+id[11]+","+id[12]+","+id[13]+", '"+Dbase.ssn+"')";
